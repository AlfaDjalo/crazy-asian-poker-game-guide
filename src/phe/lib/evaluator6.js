...
const { suits } = require('./dptables.js');
const { noflush6 } = require('./hashtable6.js');
const { flush } = require('./hashtable.js');
const { hash_quinary } = require('./hash.js');

const { binaries_by_id, suitbit_by_id } = require('./bin-bit-table.js');

// export default function evaluate_6_cards(a, b, c, d, e, f) {

module.exports = function evaluate_6_cards(a, b, c, d, e, f) {
  var suit_hash = 0
